...
grep -Fxq 'SQL_DSN=postgresql://app:db-secret@127.0.0.1/lmm_api?options=-csearch_path%3Dlmm_prod_test' "$TMP/candidate.env"
grep -Fxq 'REDIS_CONN_STRING=redis://lmm-api:valkey-secret-123456789@127.0.0.1:6380/0' "$TMP/candidate.env"
