...
fixture_dir=${1:-"$repo_root/rust/behavior-oracle/fixtures"}
request_dir=${ROUTE_REQUEST_DIR:-"$repo_root/rust/behavior-oracle/requests"}
...
capture="$repo_root/rust/scripts/capture-legacy-route-contract.sh"
