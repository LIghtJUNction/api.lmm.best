...
fixture_check="$repo_root/rust/behavior-oracle/tests/test-missing-routes-external-gateway-fixtures.sh"
listener_runner="$repo_root/rust/behavior-oracle/tests/missing-routes-local-listeners.sh"
...
test_instance="$repo_root/rust/apps/lmm-api-rs/src/test_instance.rs"
for adapter in \
