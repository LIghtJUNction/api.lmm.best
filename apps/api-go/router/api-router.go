	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.RequestEpay)
				selfRoute.POST("/fastpay/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.RequestFastPay)
				selfRoute.POST("/amount", middleware.PaymentAccessGate(), controller.RequestAmount)
				selfRoute.POST("/stripe/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.RequestStripePay)
				selfRoute.POST("/stripe/amount", middleware.PaymentAccessGate(), controller.RequestStripeAmount)
				selfRoute.POST("/creem/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.RequestCreemPay)
				selfRoute.POST("/waffo/amount", middleware.PaymentAccessGate(), controller.RequestWaffoAmount)
				selfRoute.POST("/waffo/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.RequestWaffoPay)
				selfRoute.POST("/waffo-pancake/amount", middleware.PaymentAccessGate(), controller.RequestWaffoPancakeAmount)
				selfRoute.POST("/waffo-pancake/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.RequestWaffoPancakePay)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/epay/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.SubscriptionRequestEpay)
			subscriptionRoute.POST("/fastpay/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.SubscriptionRequestFastPay)
			subscriptionRoute.POST("/stripe/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.SubscriptionRequestStripePay)
			subscriptionRoute.POST("/creem/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.SubscriptionRequestCreemPay)
			subscriptionRoute.POST("/waffo-pancake/pay", middleware.PaymentAccessGate(), middleware.CriticalRateLimit(), controller.SubscriptionRequestWaffoPancakePay)
		}
