	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff/ledger", middleware.DisableCache(), controller.GetReferralLedger)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/:id/referral-ban", middleware.RequestBodyLimit(16<<10), middleware.CriticalRateLimit(), controller.BanUserForReferralAbuse)
				adminRoute.POST("/:id/referral-ban/:case_id/restore", middleware.RequestBodyLimit(16<<10), middleware.CriticalRateLimit(), controller.RestoreUserReferralBan)
