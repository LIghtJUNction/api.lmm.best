  ...
  return {
    ...
    cell: ({ row }) => {
      ...
      const durationBgMap: Record<string, string> = {
        success: 'console-status-success-badge',
        warning: 'console-status-warning-badge',
        danger: 'console-status-danger-badge',
      }
      ...
      return (
        <>
          <button
            ...
            title={cellTitle}
          >
            <span className='console-status-danger-text truncate leading-snug group-hover:underline'>
              {failReason}
            </span>
          </button>
          <FailReasonDialog
