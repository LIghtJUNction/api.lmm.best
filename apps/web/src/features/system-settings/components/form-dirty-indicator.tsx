...
export function FormDirtyIndicator({
  ...
  return (
    <SettingsPageTitleStatusPortal>
      <span className='console-status-warning inline-flex h-5 items-center gap-1.5 rounded-none px-2 text-[11px] font-medium whitespace-nowrap'>
        <span className='console-status-warning-dot size-1.5 rounded-full' />
