...
describe('AssistantPlanTool', () => {
  test('shows live top-up discounts to L0 without requesting restricted plans', async () => {
      ...
      component: () => (
        <QueryClientProvider client={queryClient}>
          <I18nextProvider i18n={i18n}>
            <AssistantPlanTool developerAccessGranted={false} />
          </I18nextProvider>
        </QueryClientProvider>
      ),
    })
    ...
    assert.match(container.textContent ?? '', /Best current top-up discounts/)
    assert.match(container.textContent ?? '', /save 20%/)
    assert.match(container.textContent ?? '', /Add funds/)
