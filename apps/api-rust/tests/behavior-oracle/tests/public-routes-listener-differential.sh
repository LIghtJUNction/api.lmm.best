...
for route in /api/notice /api/about /api/home_page_content /api/user-agreement /api/privacy-policy; do compare "$route"; done
[[ $scenario_total == 5 ]] || { echo "scenario count mismatch: $scenario_total" >&2; exit 1; }
