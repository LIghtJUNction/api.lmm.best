...
fixtures=${1:-"$repo_root/apps/api-rust/tests/behavior-oracle/tests/missing-routes-transaction-fixtures.json"}
...
if ! $contract_only; then
  exec "$repo_root/apps/api-rust/tests/behavior-oracle/tests/missing-routes-transaction-differential.sh"
fi
