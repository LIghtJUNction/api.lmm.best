...
expected_evidence='migration gate evidence: source-present=77 compiled=0 mounted=77 unmounted=279 differential-verified=0 approved=0 production-owned-rust=0 migration-credit=0'
expected_states='migration gate states: legacy-go=279 mounted-unverified=77 candidate-pending-independent-approval=0 blocked-sol-stop=0 verified-approved=0'
