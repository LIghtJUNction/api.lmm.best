...
expected_states='migration gate states: legacy-go=285 mounted-unverified=64 candidate-pending-independent-approval=0 blocked-sol-stop=7 verified-approved=0'
