...
expected_evidence='migration gate evidence: source-present=78 compiled=0 mounted=78 unmounted=278 differential-verified=0 approved=0 production-owned-rust=0 migration-credit=0'
expected_states='migration gate states: legacy-go=278 mounted-unverified=78 candidate-pending-independent-approval=0 blocked-sol-stop=0 verified-approved=0'
