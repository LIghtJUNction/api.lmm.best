...
expected_evidence='migration gate evidence: source-present=76 compiled=0 mounted=76 unmounted=280 differential-verified=0 approved=0 production-owned-rust=0 migration-credit=0'
expected_states='migration gate states: legacy-go=280 mounted-unverified=76 candidate-pending-independent-approval=0 blocked-sol-stop=0 verified-approved=0'
