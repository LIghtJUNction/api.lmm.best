...
expected_states='migration gate states: legacy-go=285 mounted-unverified=63 candidate-pending-independent-approval=0 blocked-sol-stop=8 verified-approved=0'
