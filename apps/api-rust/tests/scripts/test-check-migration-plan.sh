...
expected_evidence='migration gate evidence: source-present=70 compiled=0 mounted=70 unmounted=286 differential-verified=0 approved=0 production-owned-rust=0 migration-credit=0'
expected_states='migration gate states: legacy-go=286 mounted-unverified=62 candidate-pending-independent-approval=0 blocked-sol-stop=8 verified-approved=0'
