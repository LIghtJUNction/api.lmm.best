...
expected_evidence='migration gate evidence: source-present=74 compiled=0 mounted=74 unmounted=282 differential-verified=0 approved=0 production-owned-rust=0 migration-credit=0'
expected_states='migration gate states: legacy-go=282 mounted-unverified=74 candidate-pending-independent-approval=0 blocked-sol-stop=0 verified-approved=0'
