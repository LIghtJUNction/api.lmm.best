...
expected_evidence='migration gate evidence: source-present=75 compiled=0 mounted=75 unmounted=281 differential-verified=0 approved=0 production-owned-rust=0 migration-credit=0'
expected_states='migration gate states: legacy-go=281 mounted-unverified=75 candidate-pending-independent-approval=0 blocked-sol-stop=0 verified-approved=0'
