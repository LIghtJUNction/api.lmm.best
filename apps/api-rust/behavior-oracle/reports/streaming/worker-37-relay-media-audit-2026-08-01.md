...
1. **P0: relay and media routes are not integrated into the production listener.**
   ...
   - `apps/api-rust/apps/lmm-api-rs/src/main.rs:68-73`
   - `apps/api-rust/apps/lmm-api-rs/src/http.rs:76-97`
   - `apps/api-rust/apps/lmm-api-rs/src/migration_routes/relay_media.rs:45-60`
