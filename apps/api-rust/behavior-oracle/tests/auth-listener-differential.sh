  ...
  (
    cd "$repo_root"
    {
      printf '%s\0' \
        ...
        apps/api-rust/apps/lmm-api-rs/Cargo.toml \
        apps/api-rust/apps/lmm-api-rs/tests/auth_pg_valkey.rs \
        apps/api-rust/behavior-oracle/tests/auth-listener-differential.sh
      find apps/api-rust/apps/lmm-api-rs/src apps/api-rust/apps/lmm-api-rs/assets apps/api-rust/crates -type f -print0
...
assert_rust_build_input_manifest_coverage() {
  ...
  for input in apps/api-rust/apps/lmm-api-rs/tests/auth_pg_valkey.rs apps/api-rust/behavior-oracle/tests/auth-listener-differential.sh; do
