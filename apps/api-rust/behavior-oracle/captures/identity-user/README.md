...
```bash
apps/api-rust/behavior-oracle/run-isolated-oracle.sh bash -lc '<scenario commands>'
```
...
bash apps/api-rust/behavior-oracle/captures/identity-user/tcp-differential.sh
```
