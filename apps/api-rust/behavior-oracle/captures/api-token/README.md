...
```bash
bash apps/api-rust/behavior-oracle/run-isolated-oracle.sh \
  bash apps/api-rust/behavior-oracle/captures/api-token/capture-live.sh
```
...
```bash
bash apps/api-rust/behavior-oracle/captures/api-token/run-local-tcp-differential.sh
```
...
bash apps/api-rust/behavior-oracle/captures/api-token/tcp-differential.sh
```
...
```bash
bash apps/api-rust/behavior-oracle/captures/api-token/run-pg18-valkey-integration.sh
```
