...
rust_binary=${LMM_API_TOKEN_RUST_BINARY:-"$repo_root/apps/api-rust/target/debug/lmm-api-rs"}
...
GO_BASE_URL="http://127.0.0.1:$go_port" RUST_BASE_URL="http://127.0.0.1:$rust_port" \
  ...
  bash "$repo_root/apps/api-rust/behavior-oracle/captures/api-token/tcp-differential.sh"
