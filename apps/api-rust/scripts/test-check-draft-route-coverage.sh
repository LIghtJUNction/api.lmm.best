...
completion_checker="$repo_root/apps/api-rust/scripts/check-draft-route-completion.sh"
...
write_legacy_stub_ledger "$complete/source-drift-legacy-equivalent-stubs.tsv" \
  "DELETE\\t/v1/models/:model\\tapps/api-rust/apps/lmm-api-rs/src/http.rs\\tgithub.com/QuantumNous/new-api/controller.RelayNotImplemented\\t$complete_baseline\\t$complete_source\\tfixture legacy-equivalent explicit 501"
...
write_outside_allowlist "$allowlisted/allowlist.tsv" \
  'GET\t/_internal/probe\tinternal\tapps/api-rust/apps/lmm-api-rs/src/http.rs\tfixture internal probe'
