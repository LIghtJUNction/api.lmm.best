...
Keep four workflow entry points. Consolidate shared steps under `.github/actions/`
...
The tests cover the four entry points, existing CI gates, trusted PR policy,
